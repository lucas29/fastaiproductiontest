...
model_file_url = 'https://drive.google.com/uc?export=download&confirm=sbrK&id=14R6wEZczDZ3gh_9NH5BYWqBQiwyYe3f5'
model_file_name = 'v2-3-stage-2'
...
async def setup_learner():
    ...
    data_bunch = ImageDataBunch.single_from_classes(path, classes, ds_tfms=get_transforms(do_flip=False, 
                                                                          max_lighting=0.,
                                                                          max_zoom=1,
                                                                          max_warp=0.,
                                                                          max_rotate=0,
